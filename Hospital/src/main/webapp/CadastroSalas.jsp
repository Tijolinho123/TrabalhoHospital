<%-- Document : CadastroSalas Author : Tulio Dias --%>
      ...
      <%@include file="Menu.jsp" %>
        ...
        <body>
          ...
          <form name="cadastro" method="get" action="${pageContext.request.contextPath}${URL_BASE}/SalasControlador">
            ...
            <input type="hidden" name="codigoSala" value="${codigoSala}" required />
            <p><label>Nome da Sala: </label><input type="text" name="nomeSala" value="${nomeSala}" size="40" required />
            </p>
            <p><label>Setor: </label><input type="text" name="setor" value="${setor}" size="40" required /></p>
          ...
          <form id="cadastroForm" name="cadastro" method="get"
            action="${pageContext.request.contextPath}${URL_BASE}/SalasControlador">
