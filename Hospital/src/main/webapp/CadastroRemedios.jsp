<%-- Document : CadastroRemedios Author : Tulio Dias --%>
      ...
      <%@include file="Menu.jsp" %>
        ...
        <body>
          ...
          <form name="cadastro" method="get" action="${pageContext.request.contextPath}${URL_BASE}/RemediosControlador">
            ...
            <input type="hidden" name="codigoRemedio" value="${codigoRemedio}" required />
            <p><label>Nome: </label><input type="text" name="nomeRemedio" value="${nomeRemedio}" size="40" required />
            </p>
            <p><label>Laboratório: </label><input type="text" name="laboratorio" value="${laboratorio}" size="40"
                required /></p>
            <p><label>Efeitos Colaterais: </label><input type="text" name="efeitosColaterais"
                value="${efeitosColaterais}" size="60" required /></p>
          ...
          <form id="cadastroForm" name="cadastro" method="get"
            action="${pageContext.request.contextPath}${URL_BASE}/RemediosControlador">
