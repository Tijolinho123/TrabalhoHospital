...
<nav>
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}${URL_BASE}/Salascontrolador?opcao=cancelar">Salas</a></li>
        <li><a href="${pageContext.request.contextPath}${URL_BASE}/Tipopacientecontrolador?opcao=cancelar">Tipopaciente</a></li>
