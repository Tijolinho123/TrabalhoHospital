<%-- Document : CadastroEquipamentos Author : Tulio Dias --%>
      ...
      <%@include file="Menu.jsp" %>
        ...
        <body>
          ...
          <form name="cadastro" method="get"
            action="${pageContext.request.contextPath}${URL_BASE}/EquipamentosControlador">
            <input type="hidden" name="opcao" value="${opcao}" required />
            <input type="hidden" name="codigoEquipamentos" value="${codigoEquipamentos}" required />
            <p><label>Nome: </label><input type="text" name="nomeEquipamentos" value="${nomeEquipamentos}" size="40"
                required /></p>
