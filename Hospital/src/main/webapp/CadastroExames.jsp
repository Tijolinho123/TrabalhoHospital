<%-- Document : CadastroExames Author : Tulio Dias --%>
      ...
      <%@include file="Menu.jsp" %>
        ...
        <body>
          ...
          <form name="cadastro" method="get" action="${pageContext.request.contextPath}${URL_BASE}/ExamesControlador">
            ...
            <input type="hidden" name="codigoExame" value="${codigoExame}" required />
            <p><label>Nome: </label><input type="text" name="nomeExame" value="${nomeExame}" size="40" required /></p>
            <p><label>Descrição: </label><input type="text" name="descricao" value="${descricao}" size="60" required />
            </p>
            <p><label>Valor: </label><input type="text" name="valor" value="${valor}" size="15" required /></p>
            <p><label>Preparo: </label><input type="text" name="preparo" value="${preparo}" size="60" required /></p>
          ...
          <form id="cadastroForm" name="cadastro" method="get"
            action="${pageContext.request.contextPath}${URL_BASE}/ExamesControlador">
