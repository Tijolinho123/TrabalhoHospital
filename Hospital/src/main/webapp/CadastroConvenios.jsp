<%-- Document : CadastroConvenios Author : Tulio Dias --%>
      ...
      <%@include file="Menu.jsp" %>
        ...
        <body>
          ...
          <form name="cadastro" method="get"
            action="${pageContext.request.contextPath}${URL_BASE}/ConveniosControlador">
            <input type="hidden" name="opcao" value="${opcao}" required />
            <input type="hidden" name="codigoConvenio" value="${codigoConvenio}" required />
            <p><label>Nome: </label><input type="text" name="nomeConvenio" value="${nomeConvenio}" size="40" required>
            </p>
            <p><label>CNPJ: </label><input type="text" name="cnpj" value="${cnpj}" size="20" required></p>
            <p><label>Telefone: </label><input type="text" name="telefoneConvenio" value="${telefoneConvenio}" size="20"
                required></p>
            <p><label>Cobertura: </label><input type="text" name="cobertura" value="${cobertura}" size="60" required>
            </p>
            <p><label>Data Início Contrato: </label><input type="date" name="dataInicioContrato"
                value="${dataInicioContrato}" required></p>
            <p><label>Data Fim Contrato: </label><input type="date" name="dataFimContrato" value="${dataFimContrato}"
                required></p>
            <input type="submit" value="Salvar" name="Salvar" style="float:left; margin-right: 3px" required>
          </form>
