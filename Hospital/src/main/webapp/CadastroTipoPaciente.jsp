<%-- Document : CadastroTipoPaciente Author : Tulio Dias --%>
      ...
      <%@include file="Menu.jsp" %>
        ...
        <body>
          ...
          <form name="cadastro" method="get"
            action="${pageContext.request.contextPath}${URL_BASE}/TipoPacienteControlador">
            <input type="hidden" name="opcao" value="${opcao}" required />
            <input type="hidden" name="codigoTipoPaciente" value="${codigoTipoPaciente}" required />
            <p><label>Nome: </label><input type="text" name="nomeTipoPaciente" value="${nomeTipoPaciente}" size="40"
                required /></p>
